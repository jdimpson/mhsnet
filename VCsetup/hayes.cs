/*
**	Call script to call a host via a Hayes compatible modem using "slowwrite".
**
**	Imports:
...
openok:
	...
	match VERSION "BSDI" openbsdi;
	next			openok2;
openbsdi:
	device "stty" "clocal";			/* Ensure CLOCAL is on. BSDI ONLY  */
	match RESULT DEVOK	openok2;	/* BSDI ONLY */
